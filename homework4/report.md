...
| 測試一   | $1,3,3,5,5,4,4,3,3,2,1,6,5,3,2$ 等同於( $A:5x^5+4x^4+3x^3  B:2x^1+6x^5+3x^2$ ) | 除法 : $(5/6) + (4x^4+3x^3-(5/2)x^2-(5/3)x) / (6x^5+3x^2+2x)$ | $0.83333$ |
| 測試二   | $1,1,1,1,2,1,3$ 等同於( $A:x^2  B:x^3$ ) | 加法 : $x^3+x^2$| $x^3+x^2$ |
| 測試二   | $1,1,1,1,2,1,3$ 等同於( $A:x^2  B:x^3$ ) | 乘法 : $x^5$| $x^5$ |
| 測試二   | $1,1,1,1,2,1,3$ 等同於( $A:x^2  B:x^3$ ) | 減法 : $-1x^3+x^2$| $-1x^3+x^2$ |
| 測試二   | $1,1,1,1,2,1,3$ 等同於( $A:x^2  B:x^3$ ) | 除法 : $x^-1$| $0$ |
